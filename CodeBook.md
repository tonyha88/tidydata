This is the Code book for the tiy data set.

If you read the tidydata set into a data frame using the following R command:
...
##1. The variables.
#==================
The 68 columns/variables names are:
...
the other variables listed above are the the average of each mean() or std() measurement for each
